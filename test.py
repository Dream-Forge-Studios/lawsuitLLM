...
stream("'피고회사가 근로자들을 월남국으로 파병시킬 당시 미국인회사로부터 앞으로 일년간 공사시공을 함에 상당한 하도급을 받았으나 그 후의 사정변경으로 하도급받은 작업량이 줄어들게 되었다는 사실로써는 민법 제661조나 본조 제1항 단서 소정 부득이한 사유라 할 수 없으므로 해고기간의 정함이 있는 위 근로자들과의 본건 해고계약은 30일 전의 예고로도 해지시킬 수 없다.' "
       "와 관련된 법은?")
