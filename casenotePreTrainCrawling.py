...
url_queue = 'https://casenote.kr/search/?q=%EA%B0%80%EB%93%B1%EA%B8%B0%EB%A7%90%EC%86%8C&sort=0&period=1&court=2&case=0&partial=0&oc=2&page='
setup_logger()
# crawl_hrefs(url_queue, 'D:\판례학습데이터\가등기말소\hrefs\가등기말소_지방법원_민사_원고일부승_최근3년_hrefs.txt')
crawl_data('D:\판례학습데이터\가등기말소\hrefs\가등기말소_지방법원_민사_원고일부승_최근3년_hrefs.txt', r"D:\판례학습데이터\가등기말소\rawJson_pt\가등기말소_지방법원_민사_원고일부승_최근3년.json", 1)
...
# 알림창 띄우기
messagebox.showinfo("완료 알림", "완료되었습니다.")
