...
def korean_textbooks(sample_num):
    dataset = load_dataset('maywell/korean_textbooks', 'claude_evol', cache_dir=custom_cache_dir, split="train")
    random_samples = dataset.select(range(sample_num))
            ...
            if file.endswith(".json"):
                ...
                with open(full_path, 'r', encoding='utf-8') as f:
                    ...
                    if 'dcss' in data and 'courtDcss' in data['dcss']:
                        courtDcss_values.append({'input_text': data['dcss']['courtDcss']})
